...
* \ingroup lte
*
* Signal parameters for Lte D2D SRS Frame
*/
struct LteSpectrumSignalParametersD2dSrsFrame : public SpectrumSignalParameters
{
  ...
  * default constructor
  */
  LteSpectrumSignalParametersD2dSrsFrame ();
  
  /**
  * copy constructor
  */
  LteSpectrumSignalParametersD2dSrsFrame (const LteSpectrumSignalParametersD2dSrsFrame& p);
