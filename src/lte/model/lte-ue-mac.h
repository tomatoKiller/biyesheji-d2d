...
//-----------------------------------------------------------------------D 2 D------------------------------------------------------------
  void DetectD2dChannelQuality(Ptr<D2dCqiDetectLteControlMessage> dcdMsg);
  void CommunicationModeChange(Ptr<ComModeLteControlMessage> msg);
  ...
  std::map<std::pair<uint16_t, uint16_t>, uint8_t> m_d2dSrcIndexMap;
//-------------------------------------------------------------D 2 D  O V E R-------------------------------------------------------------
