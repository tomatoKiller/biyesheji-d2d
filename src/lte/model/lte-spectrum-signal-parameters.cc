...
LteSpectrumSignalParametersD2dSrsFrame::LteSpectrumSignalParametersD2dSrsFrame ()
{
  NS_LOG_FUNCTION (this);
}

LteSpectrumSignalParametersD2dSrsFrame::LteSpectrumSignalParametersD2dSrsFrame (const LteSpectrumSignalParametersD2dSrsFrame& p)
: SpectrumSignalParameters (p)
{
  NS_LOG_FUNCTION (this << &p);
  src_rnti = p.src_rnti;
...
Ptr<SpectrumSignalParameters>
LteSpectrumSignalParametersD2dSrsFrame::Copy ()
{
  NS_LOG_FUNCTION (this);
  // Ideally we would use:
  //   return Copy<LteSpectrumSignalParametersUlSrsFrame> (*this);
  ...
  // but it causes a double creation of the object, hence it is less efficient.
  // The solution below is copied from the implementation of Copy<> (Ptr<>) in ptr.h
  Ptr<LteSpectrumSignalParametersD2dSrsFrame> lssp (new LteSpectrumSignalParametersD2dSrsFrame (*this), false);  
  return lssp;
}
