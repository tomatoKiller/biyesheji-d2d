...
class LteEnbMac :   public Object
{
  ...
  //-----------------------------------------------------------------------D 2 D-------------------------------------------------------------------------
  friend class D2dEnbMacMemberFfMacSchedSapUser;
  friend class D2dEnbMacMemberFfMacCschedSapUser;
  //-----------------------------------------------------------------------D 2 D-------------------------------------------------------------------------
...
//-------------------------------------------------------D 2 D------------------------------------------------------
    void SetD2dFfMacSchedSapProvider (D2dFfMacSchedSapProvider* s);
  D2dFfMacSchedSapUser* GetD2dFfMacSchedSapUser (void);
  void SetD2dFfMacCschedSapProvider (D2dFfMacCschedSapProvider* s);
  D2dFfMacCschedSapUser* GetD2dFfMacCschedSapUser (void);
//-------------------------------------------------------D 2 D  O V E R-------------------------------
  /**
...
private:
  ...
  */
  ...
  //-----------------------------------------------------------------------D 2 D-------------------------------------------------------------------------
  void DoD2dCschedCellConfigCnf(D2dFfMacCschedSapUser::CschedCellConfigCnfParameters params);
  void DoD2dCschedUeConfigCnf(D2dFfMacCschedSapUser::CschedUeConfigCnfParameters params);
  void DoD2dSchedConfigInd(D2dFfMacSchedSapUser::SchedConfigIndParameters params);
  struct d2dResUseInfo_s DoGetD2dResUseInfo();

  D2dFfMacSchedSapUser* m_d2dschedSapUser;
  D2dFfMacCschedSapUser* m_d2dcschedSapUser;
  D2dFfMacCschedSapProvider* m_d2dcschedSapProvider;
  D2dFfMacSchedSapProvider* m_d2dschedSapProvider;



  void DoSendD2dCqiDetectReq (const std::vector<d2dLinkSrsConfig>& linkList);
  // void DoReceiveD2dCqi(uint16_t src_rnti, uint16_t dst_rnti, const std::vector<double>&  sinr);
  void DoEnterD2dMode(uint16_t src_rnti, uint16_t dst_rnti, const std::vector<uint8_t>&  cqi, Vector& src_pos, Vector& dst_pos);
