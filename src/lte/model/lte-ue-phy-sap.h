...
//--------------------------------------------------D 2 D------------------------------------------------------------
  virtual void OpenD2dMode(uint16_t src_rnti, uint16_t dst_rnti) = 0;
  virtual void CloseD2dMode(uint16_t src_rnti, uint16_t dst_rnti) = 0;
  // virtual void SendD2dSrs(uint16_t dst_rnti) = 0;
  virtual void SetD2dSrsConfigForTx(uint16_t dst_rnti, uint16_t d2dSrsConfig) = 0;
  virtual void SetD2dSrsConfigForRx(uint16_t src_rnti, uint16_t d2dSrsConfig) = 0;
//------------------------------------------D 2 D  O V E R-------------------------------------------------------------
