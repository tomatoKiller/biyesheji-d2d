...
public:
  ...
  virtual AllocateNcRaPreambleReturnValue AllocateNcRaPreamble (uint16_t rnti);
    //-----------------------------------------------------------------------D 2 D-------------------------------------------------------------------------
  virtual struct d2dResUseInfo_s GetD2dResUseInfo () ;
  virtual void SendD2dCqiDetectReq(const std::vector<d2dLinkSrsConfig >& linkList);
...
EnbMacMemberLteEnbCmacSapProvider::GetD2dResUseInfo ()
{
  return m_mac->DoGetD2dResUseInfo() ;
}

void EnbMacMemberLteEnbCmacSapProvider::SendD2dCqiDetectReq(const std::vector<d2dLinkSrsConfig >& linkList)
{
  return m_mac->DoSendD2dCqiDetectReq(linkList);
}

void 
EnbMacMemberLteEnbCmacSapProvider::EnterD2dMode(uint16_t src_rnti, uint16_t dst_rnti, 
  const std::vector<uint8_t>&  cqi, Vector& src_pos, Vector& dst_pos)
{
  return m_mac->DoEnterD2dMode(src_rnti, dst_rnti, cqi, src_pos, dst_pos);
}

void 
EnbMacMemberLteEnbCmacSapProvider::LeaveD2dMode(uint16_t src_rnti, uint16_t dst_rnti)
{
  return m_mac->DoLeaveD2dMode(src_rnti, dst_rnti);
}

void 
EnbMacMemberLteEnbCmacSapProvider::UpdateD2dInfo(uint16_t src_rnti, uint16_t dst_rnti, 
  const std::vector<uint8_t>&  cqi, Vector& src_pos, Vector& dst_pos)
{
...
class D2dEnbMacMemberFfMacSchedSapUser : public D2dFfMacSchedSapUser
{
public:
  D2dEnbMacMemberFfMacSchedSapUser (LteEnbMac* mac);
...
D2dEnbMacMemberFfMacSchedSapUser::D2dEnbMacMemberFfMacSchedSapUser (LteEnbMac* mac)
  : m_mac (mac)
{
}
...
void
D2dEnbMacMemberFfMacSchedSapUser::SchedConfigInd (const struct SchedConfigIndParameters& params)
{
  m_mac->DoD2dSchedConfigInd (params);
}



class D2dEnbMacMemberFfMacCschedSapUser : public D2dFfMacCschedSapUser
{
public:
  D2dEnbMacMemberFfMacCschedSapUser (LteEnbMac* mac);

  virtual void D2dCschedCellConfigCnf (const struct CschedCellConfigCnfParameters& params);
  virtual void D2dCschedUeConfigCnf (const struct CschedUeConfigCnfParameters& params);
...
D2dEnbMacMemberFfMacCschedSapUser::D2dEnbMacMemberFfMacCschedSapUser (LteEnbMac* mac)
  : m_mac (mac)
{
}

void
D2dEnbMacMemberFfMacCschedSapUser::D2dCschedCellConfigCnf (const struct CschedCellConfigCnfParameters& params)
{
  m_mac->DoD2dCschedCellConfigCnf (params);
}

void
D2dEnbMacMemberFfMacCschedSapUser::D2dCschedUeConfigCnf (const struct CschedUeConfigCnfParameters& params)
{
  m_mac->DoD2dCschedUeConfigCnf (params);
}
...
//-----------------------------------------------------------------------D 2 D-------------------------------------------------------------------------
  m_d2dschedSapUser = new D2dEnbMacMemberFfMacSchedSapUser (this);
  m_d2dcschedSapUser = new D2dEnbMacMemberFfMacCschedSapUser (this);
//-----------------------------------------------------------------------D 2 D O V E R-------------------------------------------------------------------------
}
...
//-----------------------------------------------------------------------D 2 D-------------------------------------------------------------------------
  delete m_d2dschedSapUser;
  delete m_d2dcschedSapUser;
//-----------------------------------------------------------------------D 2 D  O V E R-------------------------------------------------------------------------
}
...
//-------------------------------------------------------------D 2 D--------------------------------------------
  else if(msg->GetMessageType () == LteControlMessage::D2D_CQI)
    {
      Ptr<D2dCqiLteControlMessage> d2dCqiMsg = DynamicCast<D2dCqiLteControlMessage> (msg);
      D2dCqiListElement_s d2dcqi = d2dCqiMsg->GetD2dCqi();
      m_cmacSapUser->ReceiveD2dCqi(d2dcqi.m_srcRnti, d2dcqi.m_dstRnti, d2dcqi.m_wbCqi);
    }
//----------------------------------------------------------D 2 D  O V E R-------------------------------------
  else
    {
...
struct d2dResUseInfo_s
LteEnbMac::DoGetD2dResUseInfo()
{
  return m_d2dcschedSapProvider->GetD2dResUseInfo();
}

void
LteEnbMac::DoD2dCschedCellConfigCnf(D2dFfMacCschedSapUser::CschedCellConfigCnfParameters params)
{
  NS_LOG_FUNCTION (this);
}
...
void
LteEnbMac::SetD2dFfMacSchedSapProvider (D2dFfMacSchedSapProvider* s)
{
  NS_LOG_FUNCTION (this);
  m_d2dschedSapProvider = s;
}

D2dFfMacSchedSapUser*
LteEnbMac::GetD2dFfMacSchedSapUser (void)
{
  NS_LOG_FUNCTION (this);
  return m_d2dschedSapUser;
}

void
LteEnbMac::SetD2dFfMacCschedSapProvider (D2dFfMacCschedSapProvider* s)
{
  NS_LOG_FUNCTION (this);
  m_d2dcschedSapProvider = s;
}

D2dFfMacCschedSapUser*
LteEnbMac::GetD2dFfMacCschedSapUser (void)
{
  NS_LOG_FUNCTION (this);
  return m_d2dcschedSapUser;
}
...
// void
// LteEnbMac::DoReceiveD2dCqi(uint16_t src_rnti, uint16_t dst_rnti, const std::vector<uint8_t>&  sinr)
// {
//   NS_LOG_FUNCTION (this);
//   m_cmacSapUser->ReceiveD2dCqi(src_rnti, dst_rnti, sinr);
// }
  ...
  const std::vector<uint8_t>&  cqi, Vector& src_pos, Vector& dst_pos)
{
  ...
  params.m_dstrnti = dst_rnti;
  params.m_dstposition = dst_pos;
  params.m_cqiList = cqi;

  m_d2dcschedSapProvider->CschedUeConfigReq(params);

  NotifyUeMode(src_rnti, dst_rnti, true);
}

void 
LteEnbMac::NotifyUeMode(uint16_t src_rnti, uint16_t dst_rnti, bool mode)
{
  ...
  const std::vector<uint8_t>&  cqi, Vector& src_pos, Vector& dst_pos)
{
  ...
  m_d2dcschedSapProvider->UpdateD2dInfo(params);
}
