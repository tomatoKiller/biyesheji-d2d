...
D2dDciLteControlMessage::D2dDciLteControlMessage()
{
  SetMessageType (LteControlMessage::D2D_DCI);
}
...
void D2dDciLteControlMessage::SetDci (D2dDciListElement_s dci)
{
  m_dci = dci;
}

D2dDciListElement_s D2dDciLteControlMessage::GetDci (void)
{
  return m_dci;
}


D2dCqiDetectLteControlMessage::D2dCqiDetectLteControlMessage()
{
  SetMessageType (LteControlMessage::D2D_CQI_DETECT);
}
...
void 
D2dCqiDetectLteControlMessage::SetSrcDst(uint16_t srcRnti, uint16_t dstRnti)
{
  m_src = srcRnti;
  m_dst = dstRnti;
}
...
void 
D2dCqiDetectLteControlMessage::SetSrsConfig(uint16_t index)
{
  m_srsConfig = index;
}

uint16_t 
D2dCqiDetectLteControlMessage::GetSrsConfig()
{
  return m_srsConfig;
}

uint16_t D2dCqiDetectLteControlMessage::GetSrc (void)
{
  return m_src;
}

uint16_t D2dCqiDetectLteControlMessage::GetDst (void)
{
  return m_dst;
}
...
D2dCqiLteControlMessage::D2dCqiLteControlMessage()
{
  SetMessageType (LteControlMessage::D2D_CQI);
}
...
void
D2dCqiLteControlMessage::SetD2dCqi(D2dCqiListElement_s d2dcqi)
{
  m_d2dCqi = d2dcqi;
}
...
D2dCqiListElement_s 
D2dCqiLteControlMessage::GetD2dCqi (void)
{
  return m_d2dCqi;
}


ComModeLteControlMessage::ComModeLteControlMessage()
{
  SetMessageType (LteControlMessage::COM_MODE);
}
...
void 
ComModeLteControlMessage::SetMode(bool mode)
{
  m_mode = mode;
}

bool 
ComModeLteControlMessage::GetMode()
{
  return m_mode;
}

void
ComModeLteControlMessage::SetSrcDst(uint16_t srcRnti, uint16_t dstRnti)
{
  m_src = srcRnti;
  m_dst = dstRnti;
}
...
uint16_t 
ComModeLteControlMessage::GetSrc (void)
{
  return m_src;
}
...
uint16_t 
ComModeLteControlMessage::GetDst (void)
{
  return m_dst;
}
